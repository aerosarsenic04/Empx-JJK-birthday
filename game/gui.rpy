...
define gui.radio_button_borders = Borders(21, 5, 5, 5)

define gui.check_button_borders = Borders(21, 5, 5, 5)
...
define gui.choice_button_width = 889
define gui.choice_button_height = None
define gui.choice_button_tile = False
define gui.choice_button_borders = Borders(113, 6, 113, 6)
...
define gui.slot_button_width = 311
define gui.slot_button_height = 232
...
define gui.confirm_frame_borders = Borders(45, 45, 45, 45)

## The frame that is used as part of the skip screen.
define gui.skip_frame_borders = Borders(18, 6, 57, 6)

## The frame that is used as part of the notify screen.
define gui.notify_frame_borders = Borders(18, 6, 45, 6)
...
## speaking character.
define gui.history_name_xpos = 175
define gui.history_name_ypos = 0
define gui.history_name_width = 175
define gui.history_name_xalign = 1.0

## The position, width, and alignment of the dialogue text.
define gui.history_text_xpos = 192
define gui.history_text_ypos = 3
define gui.history_text_width = 833
...
## The position, width, and alignment of the label giving the name of the
## speaking character.
define gui.nvl_name_xpos = 484
define gui.nvl_name_ypos = 0
define gui.nvl_name_width = 169
define gui.nvl_name_xalign = 1.0

## The position, width, and alignment of the dialogue text.
define gui.nvl_text_xpos = 507
define gui.nvl_text_ypos = 9
define gui.nvl_text_width = 664
define gui.nvl_text_xalign = 0.0

## The position, width, and alignment of nvl_thought text (the text said by the
## nvl_narrator character.)
define gui.nvl_thought_xpos = 270
define gui.nvl_thought_ypos = 0
define gui.nvl_thought_width = 878
define gui.nvl_thought_xalign = 0.0

## The position of nvl menu_buttons.
define gui.nvl_button_xpos = 507
...
init python:
    ...
    def touch():
        ...
        gui.quick_button_borders = Borders(45, 16, 45, 0)
    ...
    def small():
        ...
        ## Font sizes.
        gui.text_size = 34
        gui.name_text_size = 41
        gui.notify_text_size = 29
        gui.interface_text_size = 34
        gui.button_text_size = 34
        gui.label_text_size = 39

        ## Adjust the location of the textbox.
        gui.textbox_height = 270
        gui.name_xpos = 90
        gui.dialogue_xpos = 102
        gui.dialogue_width = 1238

        ## Change the size and spacing of various things.
        gui.slider_size = 41

        gui.choice_button_width = 1395
        gui.choice_button_text_size = 34

        gui.navigation_spacing = 23
        gui.pref_button_spacing = 12

        gui.history_height = 214
        gui.history_text_width = 777

        gui.quick_button_text_size = 23
        ...
        gui.nvl_name_width = 344
        gui.nvl_name_xpos = 366

        gui.nvl_text_width = 1030
        gui.nvl_text_xpos = 389
        gui.nvl_text_ypos = 6

        gui.nvl_thought_width = 1395
        gui.nvl_thought_xpos = 23

        gui.nvl_button_width = 1395
        gui.nvl_button_xpos = 23
